...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Coin Sort. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Coin Sort sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Coin Sort' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Coin Sort?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Coin Sort.</p>
                </div>
            </div>
