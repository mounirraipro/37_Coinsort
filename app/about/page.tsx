...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Coin Sort',
        url: 'https://coinsort.online/about',
        description: 'Learn about Coin Sort, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Coin Sort',
            url: 'https://coinsort.online',
        },
    },
    {
        '@context': 'https://schema.org',
...
export const metadata: Metadata = {
    title: 'About Us – Coin Sort',
    description: 'Learn about Coin Sort, our mission, and the team behind the game.',
    keywords: ['about Coin Sort', 'game team', 'who made Coin Sort'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Coin Sort</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Coin Sort was born from a simple idea: what if playing Coin Sort could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Coin Sort with a clear vision — to create a free, accessible, and
                    ...
                    Coin Sort has something for you.
                </p>
                ...
                <p>
                    Every level in Coin Sort is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Coin Sort offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Coin Sort better for
                    everyone.
                </p>
            </div>
        </>
