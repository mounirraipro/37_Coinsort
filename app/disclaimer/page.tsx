...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Coin Sort disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Coin Sort disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Coin Sort (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on coinsort.online
                ...
                <p>
                    Coin Sort is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Coin Sort displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Coin Sort.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Coin Sort is not responsible for any errors
