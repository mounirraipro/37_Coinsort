...
export const metadata: Metadata = {
    ...
    description: 'Coin Sort is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Coin Sort for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Coin Sort and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Coin Sort is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Coin Sort with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Coin Sort:
                </p>
                <ul>
                ...
                <p>
                    Coin Sort does not collect any personal information from children. There are no
                ...
                <p>
                    Coin Sort is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Coin Sort is carefully curated to be appropriate for all ages.
                    All content in Coin Sort is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Coin Sort displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Coin Sort
                ...
                <p>
                    While Coin Sort is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Coin Sort as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Coin Sort,
