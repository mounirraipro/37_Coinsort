...
const SUPPORT_EMAIL = 'hello@coinsort.online';

export const metadata: Metadata = {
    title: 'Contact Coin Sort',
    description: 'Get in touch with the Coin Sort team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Coin Sort', 'Coin Sort support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
