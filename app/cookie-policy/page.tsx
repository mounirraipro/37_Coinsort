...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Coin Sort uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Coin Sort cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Coin Sort uses them, and how you can
                ...
                <p>Coin Sort uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Coin Sort.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@coinsort.online</strong>.
                </p>
            </div>
        </>
    );
