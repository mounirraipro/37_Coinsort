...
export const metadata: Metadata = {
    ...
    description: 'Coin Sort is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Coin Sort accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Coin Sort accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Coin Sort is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Coin Sort presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Coin Sort. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@coinsort.online</strong></li>
                </ul>
                <p>
