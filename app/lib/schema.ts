...
const SITE_URL = 'https://coinsort.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Coin Sort',
        url: SITE_URL,
        description: 'Play Coin Sort free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Coin Sort online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
