...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Coin Sort puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Coin Sort categories'],
  alternates: {
