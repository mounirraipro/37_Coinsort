...
export const metadata: Metadata = {
    ...
    description: 'Read the Coin Sort Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Coin Sort privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Coin Sort, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Coin Sort, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Coin Sort is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@coinsort.online</strong>.
                </p>
            </div>
        </>
    );
